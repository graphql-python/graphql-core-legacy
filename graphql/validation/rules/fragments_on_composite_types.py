...
def inline_fragment_on_non_composite_error_message(type_):
    return "Fragment cannot condition on non composite type '{}'.".format(type_)


def fragment_on_non_composite_error_message(frag_name, type_):
