...
class Source:
    ...
    def __init__(self, body, name=None, location_offset=None):
        ...
        `name` and `location_offset` are optional. They are useful for clients
        who store GraphQL documents in source files; for example, if the
        GraphQL input starts at line 40 in a file named Foo.graphql, it might
