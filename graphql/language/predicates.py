...
def is_executable_definition_node(node):
    # type: (Node) -> bool
    return isinstance(node, ExecutableDefinitionNode)


def is_selection_node(node):
    # type: (Node) -> bool
