...
ComplicatedArgs = GraphQLObjectType(
    ...
    OrderedDict(
        (
            ...
            (
                "enumArgField",
                GraphQLField(GraphQLString, {"enumArg": GraphQLArgument(FurColor)}),
            ),
            (
                "floatArgField",
                GraphQLField(
            ...
            (
                "idArgField",
                GraphQLField(GraphQLString, {"idArg": GraphQLArgument(GraphQLID)}),
            ),
            (
                "stringListArgField",
                GraphQLField(
            ...
            (
                ...
                GraphQLField(
                    ...
                    {
                        "arg": GraphQLArgument(
                            GraphQLNonNull(GraphQLInt), default_value=0
                        )
                    },
                ),
            ),
