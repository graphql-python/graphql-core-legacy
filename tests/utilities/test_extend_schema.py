...
def extend_test_schema(sdl, **options):
...
def describe_extend_schema():
    ...
    def correctly_assigns_ast_nodes_to_new_and_extended_types():
        ...
        restored_extension_ast = DocumentNode(
            definitions=(
                list(query.extension_ast_nodes)
                + list(some_scalar.extension_ast_nodes)
                + list(some_enum.extension_ast_nodes)
                + list(some_union.extension_ast_nodes)
                + list(some_input.extension_ast_nodes)
                + list(some_interface.extension_ast_nodes)
                + [
                    test_input.ast_node,
                    test_enum.ast_node,
                    test_union.ast_node,
