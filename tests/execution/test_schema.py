...
from graphql.type import (
    GraphQLArgument, GraphQLBoolean, GraphQLField, GraphQLID,
    ...
    def executes_using_a_schema():
        ...
        BlogAuthor = GraphQLObjectType('Author', lambda: {
            ...
            'pic': GraphQLField(BlogImage, args={
                ...
                resolve=lambda obj, info, width, height:
                    obj.pic(info, width, height)),
        ...
        BlogQuery = GraphQLObjectType('Query', {
            'article': GraphQLField(
                BlogArticle, args={'id': GraphQLArgument(GraphQLID)},
